पैकेज इंस्टॉल करने के लिए आपके Raspberry Pi को ऑनलाइन होना होगा। पैकेज इंस्टॉल करने से पहले, अपने Raspberry Pi के प्रचालन तंत्र, Raspbian को अपडेट और अपग्रेड करें।
